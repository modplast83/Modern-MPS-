...
import { Package, Printer, CheckCircle2, ArrowRight, Loader2, Info } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex">
        ...
        <main className="flex-1 lg:mr-64 p-4 pb-20 lg:pb-4">
          <div className="mb-6">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">لوحة عامل الطباعة</h1>
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-400">إدارة رولات الطباعة ونقلها إلى التقطيع</p>
          </div>
          ...
          {productionOrders.length === 0 ? (
            <Card className="p-8" data-testid="card-no-rolls">
              <div className="text-center">
                ...
                <h3 className="text-xl md:text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-2">لا توجد رولات في مرحلة الطباعة</h3>
                <p className="text-base md:text-lg text-gray-600 dark:text-gray-400" data-testid="text-no-rolls">لا توجد رولات جاهزة للطباعة حالياً</p>
              </div>
            </Card>
          ) : (
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="text-base md:text-lg">
                          <span className="font-medium text-blue-900 dark:text-blue-100">إجمالي الوزن: </span>
