      ...
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-3">
              <div>
                <span className="text-sm font-medium text-gray-500">{t('common.createdAt')}</span>
              ...
              <div>
                ...
                <p className="text-base">{order.delivery_days || t('common.notSpecified')} {t('common.day')}</p>
              </div>
              <div>
